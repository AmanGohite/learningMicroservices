...
import com.banking.leaningbank.model.ReversePayment;
...
public class CustomerService {	
	...
	public synchronized void reversePayment(ReversePayment reverse) {
		Double balance = this.getAccountBalance(reverse.getCustomerId());
		Double updatedBalance = balance+reverse.getPrice();
		try {
			Account a = accountRepo.findByCustomerId(reverse.getCustomerId());
			if(a != null) {
