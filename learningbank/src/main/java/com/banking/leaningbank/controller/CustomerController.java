...
public class CustomerController {
	...
	public void reverseTransfer(@RequestBody ReversePayment reverse){
		String json = new Gson().toJson(reverse);
		logger.info("request received for fund reverse {}", json);
		custService.reversePayment(reverse);
