...
public class CustomerService {
	...
	public GenericAPIResponse placeOrder(PlaceOrder placeOrder) {
		GenericAPIResponse resp = new GenericAPIResponse();
		System.out.println(placeOrder.getProductId());
		try {
			Product prod = this.getProductDetails(placeOrder.getProductId());
			if(prod != null) {
				Orders order = new Orders(placeOrder.getCustomerId(), prod.getName(), prod.getPrice(), placeOrder.getQuantity());
